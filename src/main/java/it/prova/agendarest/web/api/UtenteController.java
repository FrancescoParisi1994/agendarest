...
public class UtenteController {
	...
	public List<AgendaDTO> findAll() {
		return AgendaDTO.buildDTOListFromModelList(agendaService.findAll());
	}
	
	@GetMapping("/{id}")
	public AgendaDTO findById(@PathVariable(required = true)Long id) {
		return AgendaDTO.buildDTOFromModel(agendaService.findById(id));
	}
}
